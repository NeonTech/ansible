...
4. Test connections to hosts:
   ...
   `ansible all --inventory ./inventories/production/hosts.ini --vault-password-file ./vault-password-file --module-name ansible.builtin.ping`

5. Run the `site.yml` playbook to deploy **_everything_**:

   `ansible-playbook --inventory ./inventories/production/hosts.ini --vault-password-file ./vault-password-file site.yml`
